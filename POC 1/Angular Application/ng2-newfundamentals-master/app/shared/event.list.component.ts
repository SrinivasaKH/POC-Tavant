...
export class EventList implements OnInit {
    ...
    constructor(private eventservce: EventService,  private route:ActivatedRoute) {

    }
    ngOnInit() {
        
        //this.events = this.eventservce.getEvents()
        //this.eventservce.getEvents().subscribe(events => {this.events = events})
